...
// Copyright (C) 2008-2009 Disruptive Tech
...
/**
 * MetamodelInitHandler extends {@link MofInitHandler} to generate 
 * registrations calls for Enki's built-in MOF M0 model.
 * 
 * @author Stephan Zuercher
 */
public class MetamodelInitHandler extends MofInitHandler
{
    ...
    public MetamodelInitHandler(SubordinateHandler subordinateHandler)
    {

    ...
    implements javax.jmi.model.Reference
{
    ...
    {
        return exposedEnd.getExposedEnd(this);
    }
    ...
    {
        return referencedEnd.getReferencedEnd(this);
    }

...
/**
 * Implements MOF's Class class proxy interface.
 *
 * @author {@link org.eigenbase.enki.codegen.MofImplementationHandler}
 */
public class MofClassClass
    extends RefClassBase
    implements javax.jmi.model.MofClassClass
{
    MofClassClass(
    ...
    {
        return org.eigenbase.enki.jmi.model.MofClass.class;
    }
}

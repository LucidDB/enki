    ...
    extends MetamodelInitializer
{
    ...
    private void exposesAssocInit()
    {
        ...
        exposesAssoc.add(reference[0], associationEnd[19]);
        exposesAssoc.add(reference[1], associationEnd[8]);
        exposesAssoc.add(reference[2], associationEnd[10]);
        exposesAssoc.add(reference[3], associationEnd[6]);
        exposesAssoc.add(reference[4], associationEnd[2]);
        exposesAssoc.add(reference[5], associationEnd[4]);
        exposesAssoc.add(reference[6], associationEnd[1]);
        exposesAssoc.add(reference[7], associationEnd[13]);
        exposesAssoc.add(reference[8], associationEnd[14]);
        exposesAssoc.add(reference[9], associationEnd[9]);
        exposesAssoc.add(reference[10], associationEnd[15]);
        exposesAssoc.add(reference[11], associationEnd[16]);
    }
    ...
    public void initMetamodel()
    {
        ...
        ModelPackage modelPackage = new org.eigenbase.enki.jmi.model.ModelPackage();

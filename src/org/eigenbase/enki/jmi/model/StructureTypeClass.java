...
/**
 * Implements MOF's StructureType class proxy interface.
 *
 * @author {@link org.eigenbase.enki.codegen.MofImplementationHandler}
 */
public class StructureTypeClass
    extends RefClassBase
    implements javax.jmi.model.StructureTypeClass
{
    StructureTypeClass(
    ...
    {
        org.eigenbase.enki.jmi.model.StructureType instance = 
            new org.eigenbase.enki.jmi.model.StructureType(this);
        register(instance);
        return instance;
    }
    ...
    {
        org.eigenbase.enki.jmi.model.StructureType instance =
            new org.eigenbase.enki.jmi.model.StructureType(
                this,
                name,
                annotation,
                isRoot,
    ...
    {
        return org.eigenbase.enki.jmi.model.StructureType.class;
    }
}

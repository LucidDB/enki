...
public class DoodadImpl extends AssociationBase implements Doodad
{
    private long id;
    private String name;
    int doodadMode;
    ...
    public int getDoodadMode()
    {
        return doodadMode;
    }

    public void setDoodadMode(int doodadMode)
    {
        this.doodadMode = doodadMode;
    }    
